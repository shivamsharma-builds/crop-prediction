...
export function AdminLogin() {
  ...
  return <div className="flex min-h-screen items-start justify-center bg-[#f5f5f5] px-3 py-5 sm:items-center sm:py-8">
    <div className="w-full max-w-[410px] rounded-[4px] border border-gray-200 bg-white p-6 shadow-soft">
